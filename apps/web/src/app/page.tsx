          ...
          <div className="growth-tool-card">
            <div>
              ...
              <p style={{ color: '#64748B', fontSize: '0.96rem', lineHeight: '1.65', marginBottom: '24px' }}>
                Find out why competing local businesses in Ameerpet, Kukatpally, Vizag, Coimbatore, Kochi, Chennai, Vijayawada or Bengaluru rank higher on Google Maps. Get a side-by-side comparative scorecard in 10 seconds.
              </p>
            </div>
            <div>
