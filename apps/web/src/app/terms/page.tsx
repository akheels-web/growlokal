        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', fontSize: '0.98rem', lineHeight: '1.75', color: '#0E4459' }}>
          <section>
            ...
            <p style={{ marginTop: '12px' }}>
              By accessing our website, creating an account, using our free Google Business Profile audit, or subscribing to a paid plan, you agree to be bound by these Terms of Service and our <Link href="/privacy" style={{ color: '#2E9AA6', fontWeight: 600 }}>Privacy Policy</Link>, which is incorporated into these Terms by reference. If you do not agree, please do not use our services.
            </p>
          </section>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#033540', marginBottom: '12px' }}>5. Subscription Plans &amp; Feature Access</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#033540', marginBottom: '12px' }}>6. Auto-Renewal &amp; Billing</h2>
            <p>
              Paid subscriptions renew automatically at the end of each billing period using your saved payment method, unless cancelled beforehand. We will send you a reminder via WhatsApp and/or email approximately <strong>7 days before your renewal date</strong>. You can cancel auto-renewal at any time through your dashboard or by contacting support (see our <Link href="/refund" style={{ color: '#2E9AA6', fontWeight: 600 }}>Refund &amp; Cancellation Policy</Link> for details).
            </p>
          </section>

          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#033540', marginBottom: '12px' }}>7. What Happens If a Payment Lapses</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#033540', marginBottom: '12px' }}>8. AI-Generated Content</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#033540', marginBottom: '12px' }}>9. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#033540', marginBottom: '12px' }}>10. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#033540', marginBottom: '12px' }}>11. Governing Law &amp; Dispute Resolution</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#033540', marginBottom: '12px' }}>12. Contact &amp; Support</h2>
            <p>
