    ...
    <div className="page-wrapper" style={{ background: '#ffffff', color: '#111827' }}>
      ...
      <main style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 24px 90px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', fontSize: '0.98rem', lineHeight: '1.75', color: '#0B1020' }}>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#111827', marginBottom: '12px' }}>1. Free Instant Audit (No Risk)</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#111827', marginBottom: '12px' }}>2. Subscription Cancellation Terms</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#111827', marginBottom: '12px' }}>3. How Refund Requests Are Processed</h2>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#111827', marginBottom: '12px' }}>4. What Happens to Your Account After a Refund</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#111827', marginBottom: '12px' }}>5. WhatsApp Broadcast Campaign Credits</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: '1.35rem', color: '#111827', marginBottom: '12px' }}>6. Contact Us for Billing Help</h2>
