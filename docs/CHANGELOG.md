...
Added (all authored, NOT yet run/typechecked — validate with `pnpm install && pnpm --filter @prachaar/api typecheck`):
...
- Business onboarding form; WhatsApp chat agent (RAG over profile_context); Cal.com booking microsite.
